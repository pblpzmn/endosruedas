...
<div class="container">
	...
	<div class="row">
	 	...
	 	<?php if ($product->status==$constant::STOLEN){ ?>
	 		<h3 class="stolen">Bicicleta Robada, ayúdanos a encontrarla</h3>
	 	<?php } ?>
	  <!-- Start Carousel   -->
			  ...
			  <div class="carousel-inner">
			  	@foreach ($product->hasPicture() as $key => $picture)
				    ...
				    @else
				    	<div class="item">
				    @endif
				      <img src="../../{!!$picture->path!!}" class="img-responsive" alt="bici">
...
<!-- 				<li id="preguntasLi"><a href="#preguntas" data-toggle="tab" id="preguntasTab">Preguntas previas</a></li> -->
			...
			<div class="tab-content">
			  <div class="tab-pane" id="buying">
					...
					{!! Form::open(array('url' => 'comprar/bicicleta/'.$product->id ,'class' => 'form-horizontal' ,'files' => true, 'id'=>'validateForm')) !!}
...
<!--							{!! Form::submit('Comprar', array('class' => 'btn btn-default')) !!}-->
			  ...
			  <div class="tab-pane active" id="details">
						...
						<h4 class=" text-center">Datos de la bicicleta:</h4>
						...
						<div class="col-md-4 col-lg-6" >	
							<p class=" text-left">
								...
								{!! $constant::bikeSizeName()[$product->size] !!}
							</p>
						</div>
